...
class Side extends React.Component {
  ...
  loadItemList() {
    actionUtils.loadItem(
      this.props.store,
      this.props.actions.loadingItemList,
      this.props.actions.loadItemList
    );
  }
  render() {
    return (
      <aside>
        <Sidebar
          ...
          <Menu.Item
            ...
            onClick={this.props.actions.onShutDownClick}>
          ...
          <Menu.Item
            ...
            as={Icon}
            className={styles.icon}
            onClick={this.props.actions.onRssListModalClick}>
            <RssListModal
              actions={this.props.actions}
              open={this.props.rssListModal}
              rssList={this.props.rssList}
          ...
          <Menu.Item
            ...
            as={Icon}
            className={styles.icon}
            onClick={this.props.actions.onMimizeClick}>
          ...
          <Menu.Item
            ...
            as={Icon}
            className={styles.icon}
            onClick={this.props.actions.onSettingsModalClick}>
            <SettingsModal
              actions={this.props.actions}
              store={this.props.store}
              open={this.props.settingsModal}
          ...
          <Menu.Item
            ...
            as={Icon}
            className={styles.icon}
            onClick={this.props.actions.onOpenGithubClick}>
